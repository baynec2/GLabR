...
I have hosted this database as a postgres sql database on aws due to the large size (~5gb)

the annotate_megadb function is designed to make it as easy as possible to interact with this database from within R.
