...
p3
```
Here we can see the overall distribution of the data. 


```{r}
#Lets look at one Plex combo

fd = data %>% 
  filter(Sample == "DG014843")

p1 = fd %>% 
  ggplot(aes(box_cox_scaled_values))+
  geom_density()+
  ggtitle("box cox scaled values")+
  facet_wrap(~TMT,scales = "free_y")
...
Not sure if this is working as expected or not. Will update later. 
