...
This suggests to me that the current implementation of GLabR is pretty good and we can be largely confident in the results that are produced. It seems the major differences between the two groups is that proteome discoverer considers peptide uniqueness when rolling up into protein quantifications. 
